<template>
  <div
    class="p-4 items-center justify-center w-[680px] rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 hover:rounded-2xl"
  >
    <img
    ...
    <div class="sm:w-8/12 pl-0 p-5">
      <div class="space-y-2">
        <div class="space-y-4">
          <h4 class="text-lg font-semibold text-cyan-900 text-justify">
