export function info(title, message) {
  return (
    ...
    message +
    `</div>
					<div class="text-lg hidden"><progress class="progress w-full" value="50" max="100"></progress></div>
			</div>
			<div class="flex-none">
...
export function error(title, message) {
  return (
    ...
    message +
    `</div>
					<div class="text-lg hidden"><progress class="progress w-full" value="0" max="100"></progress></div>
			</div>
			<div class="flex-none">
					<button class="btn btn-circle btn-sm" onclick="window.removeWindToast(event)">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
