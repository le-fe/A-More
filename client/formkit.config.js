  ...
  config: {
    classes: generateClasses({
      ...
      "family:dropdown": {
        ...
        listitem:
          'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-gray-700 aria-selected:bg-gray-700 aria-selected:text-white',
        loaderIcon: "ml-auto",
        loadMoreInner:
